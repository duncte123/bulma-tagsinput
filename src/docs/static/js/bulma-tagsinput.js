/*! @duncte123/bulma-tagsinput v1.0.7 | (c) 2021 Gaetan | MIT License | https://github.com/CreativeBulma/bulma-tagsinput */
...
if(this._objectItems&&a.filter(function(a){return(0,_type.isObject)(a)}).length!==a.length)throw"Item must be an object or an array of objects";a.forEach(function(a){b.selectAtIndex(b.indexOf(a))})}return this}/**
     ...
     * Get selected item
     */},{key:"selected",get:function get(){return 0<=this._selected?this.items[this._selected]:null}/**
     ...
     * Set value
     */,set:function set(a){this.removeAll(),this.add(a)}/**
     * Document click event handler
     * @param {Event} e
     */},{key:"_onDocumentClick",value:function _onDocumentClick(a){if(this.dropdown){// If we click on element inside container then do nothing
